...
class SidebarButton extends StatelessWidget {
  ...
  SidebarButton({required this.text, required this.onPressed});
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              "Date: ${request['date']}\n"
              "Time: ${request['time']}",
              style: TextStyle(fontSize: 14, color: Color(0xff9da6c4)),
            ),
            SizedBox(height: 10),
            Row(
