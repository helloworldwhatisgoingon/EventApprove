...
class FacultyAchievementsView extends StatefulWidget {
  ...
  @override
  State<FacultyAchievementsView> createState() =>
      _FacultyAchievementsViewState();
}
...
class _FacultyAchievementsViewState extends State<FacultyAchievementsView> {
  ...
  Future<void> fetchEvent() async {
    final _conf = await repository.fetchEvents('faculty_achievements');
    setState(() {
      facultyAchievements = _conf;
  ...
  void clearFilters() {
    setState(() {
      ...
      filteredConferences =
          List.from(facultyAchievements); // Reset to original data
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: _filterService.buildAppBar(
        ...
        conferences: facultyAchievements,
        filename: 'Faculty Achievements',
