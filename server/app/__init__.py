...
from app.routes.conference_routes import bp as conference_bp
from app.routes.centralized_routes import bp as centralized_bp
...
def create_app():
    ...
    app.register_blueprint(centralized_bp)
